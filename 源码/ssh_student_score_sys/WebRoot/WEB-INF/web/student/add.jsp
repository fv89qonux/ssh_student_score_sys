		...
		<div class="box">
			<div class="box_border">
				<div class="box_center">
					<form action="${ctx }/student/add.html" class="jqtransform" onsubmit="return toVaild()" method="post">
					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td class="td_right">姓名：</td>
							<td><input type="text" name="student.name" id="name" class="input-text lh30" size="40" maxlength="20"></td>
						</tr>
						<tr>
							<td class="td_right">学号：</td>
							<td><input type="text" name="student.num" id="num" class="input-text lh30" size="40" maxlength="20"></td>
						</tr>
						<tr>
	               			...
	               			<td class="">
	                    		<span class="fl">
	                        		...
	                        		<div class="select_containers "> 
				                        <select name="student.cid" class="select"> 
